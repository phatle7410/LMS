...
import Rating from '../../compoments/student/Rating'
    ...
    <div className='p-4 sm:p-10 flex flex-col-reverse md:grid md:grid-cols-2 gap-10 md:px-36'>
      ...
      {/* trái Section */}
        <div className='text-gray-800'>
          <h2 className='text-xl font-semibold'>Cấu Trúc Bài Học</h2>
          <div className='pt-5'>
                                      ...
                                      {chapter.chapterContent.map((lecture, i)=> (
                                        <li key={i} className='flex items-start gap-2 py-1'>
                                          <img src={progressData && progressData.lectureCompleted.includes(lecture.lectureId)
                                           ? assets.blue_tick_icon : assets.play_icon} alt="play icon" className='w-4 h-4 mt-1' />
                                          <div className='flex items-center justify-between w-full text-gray-800 text-xs md:text-default'>
                                            ...
                                            <div className='flex gap-2'>
                                              ...
                                              className='text-blue-500 cursor-pointer'>Xem</p>}
        ...
        <h1 className='text-xl font-bold'>Đánh Giá Bài Học</h1>
          ...
          {playerData ? (
            <div>
              ...
              <div className='flex justify-between items-center mt-1'>
                ...
                <button onClick={()=> markLectureAsCompleted(playerData.lectureId)} className='text-blue-600'>{progressData && progressData.lectureCompleted.includes(playerData.lectureId) ? 'Hoàn Thành' : 'Đánh Dấu Đã Hoàn Thành'}</button>
              </div>
            </div>
          )
          :
