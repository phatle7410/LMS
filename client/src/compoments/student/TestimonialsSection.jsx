...
const TestimonialsSection = () => {
  return (
    <div className='pb-14 px-8 md:px-0'>
      <h2 className='text-3xl font-medium text-gray-800'>Đánh Giá</h2>
      <p className='md:text-base text-gray-500 mt-3'>Nghe chia sẻ từ các bậc phụ huynh học viên về hành trình học tập của con em</p>
        ...
        {dummyTestimonial.map((testimonial, index)=>(
          <div key={index} className='text-sm text-left border border-gray-500/30 pb-6 rounded-lg bg-white shadow-[0px_4px_15px_0px] shadow-black/5 overflow-hidden'>
            ...
            <div className='p-5 pb-7'>
              ...
              <a href="#" className='text-blue-500 underline px-5'>Đọc Thêm</a>
          </div>
        ))}
      </div>
